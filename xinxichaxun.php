...
<?php include "leftmenu.php" ?>
		  ...
		  <div class="content">
			...
			<form class="sui-form form-horizontal sui-validate" action="xinxichaxun-list.php" method="post">
				<div class="control-group">
					<label for="surname" class="control-label">姓名:</label>
					<div class="controls">
						<input type="text" id="surname" name="surname" class="input-large input-fat" placeholder="输入姓名" data-rules="required|minlength=2|maxlength=10">
					</div>
				</div>
				<div class="control-group">
